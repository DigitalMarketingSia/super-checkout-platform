                    ...
                    <Link to={appLink} className="flex items-center gap-2 hover:scale-105 transition-transform">
                        {memberArea?.logo_url ? (
                            ...
                            <div className="text-red-600 font-bold text-2xl tracking-tighter">
                                {memberArea?.name?.toUpperCase() || t('layout.member_fallback')} <span className="text-white text-xs font-normal tracking-normal opacity-70">{t('layout.area_suffix')}</span>
                            </div>
                        )}
                    </Link>
                </div>
                ...
                <div className="p-6 flex items-center justify-between border-b border-white/5">
                    <div className="flex items-center gap-2">
                        {memberArea?.logo_url ? (
                            ...
                            <span className="font-bold text-lg tracking-tight">{memberArea?.name || t('layout.menu')}</span>
                        )}
                    </div>
                    <button
                        onClick={() => setIsSidebarOpen(false)}
                ...
                {!memberArea?.custom_branding && (
                    <div className="p-6 border-t border-white/5">
                        <div className="flex items-center justify-center gap-1 text-xs text-gray-600 font-medium">
                            <span className="text-[10px]">{t('layout.created_by')}</span>
