        ...
        <div className="container mx-auto px-4 md:px-8 py-8">
            ...
            {products.length === 0 ? (
                <div className="text-center py-12 bg-white/5 rounded-xl border border-white/10">
                    ...
                    <h3 className="text-xl font-bold text-white mb-2">{t('products.empty_title')}</h3>
                    <p className="text-gray-400">{t('products.empty_desc')}</p>
                </div>
            ) : (
                        ...
                        >
                            ...
                            <div className="p-5">
                                ...
                                <div className="flex items-center justify-between mt-auto">
                                    ...
                                    >
                                        {t('products.buy')} <ExternalLink className="w-3 h-3" />
                                    </button>
                                </div>
                            </div>
                        </div>
