...
export const MyProducts: React.FC = () => {
    ...
    return (
        <div className="container mx-auto px-4 md:px-8 py-8">
            <div className="mb-8">
                <h1 className="text-3xl font-bold text-white mb-2">{t('my_products.title')}</h1>
                <p className="text-gray-400">{t('my_products.subtitle')}</p>
            </div>

            {ownedProducts.length === 0 ? (
                <div className="text-center py-12 bg-white/5 rounded-xl border border-white/10">
                    <Package className="w-12 h-12 text-gray-500 mx-auto mb-4" />
                    <h3 className="text-xl font-bold text-white mb-2">{t('my_products.empty_title')}</h3>
                    <p className="text-gray-400 mb-6">{t('my_products.empty_desc')}</p>
                    <button
                    ...
                    {ownedProducts.map(product => (
                        ...
                        >
                            ...
                            <div className="p-5">
                                ...
                                >
                                    <Play className="w-4 h-4" /> {t('my_products.access_content')}
                                </button>
                            </div>
                        </div>
                    ))}
