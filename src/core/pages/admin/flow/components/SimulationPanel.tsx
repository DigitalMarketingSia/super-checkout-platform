            ...
            <div className="p-8 pb-4 border-b border-white/5 bg-gradient-to-b from-white/[0.02] to-transparent relative overflow-hidden">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h2 className="text-sm font-black text-white uppercase tracking-[0.2em] italic">Relatório Estratégico</h2>
                ...
                <div className="flex gap-2">
                  <div className="px-3 py-1 rounded-full bg-[#27CBEF]/10 border border-[#27CBEF]/20 flex items-center gap-2">
                    ...
                    <span className="text-[8px] font-black text-[#27CBEF] uppercase tracking-widest">Otimização</span>
                  </div>
            ...
            <div className="flex-1 overflow-y-auto p-8 space-y-8 custom-scrollbar pb-10">
              ...
              <section className="space-y-4">
                ...
                <div className="p-8 rounded-[32px] bg-gradient-to-br from-emerald-500/15 to-transparent border border-emerald-500/10 relative overflow-hidden group">
                  <div className="relative z-10 flex items-center justify-between">
                    <div>
                      <p className="text-[10px] font-black text-emerald-400 uppercase tracking-[0.3em] mb-3">Lucro Líquido Previsto</p>
                    ...
                    <div className="text-right">
                      ...
                      <p className="text-[9px] font-black text-slate-500 uppercase tracking-widest">Performance Global</p>
                    </div>
                  </div>
                </div>
              </section>
              ...
              <section className="grid grid-cols-2 gap-4">
                <div className="p-6 glass rounded-[24px] border border-white/5 space-y-3">
                  ...
                  <div>
                    <p className="text-[9px] font-black text-slate-500 uppercase tracking-[0.1em] mb-0.5">Receita Total</p>
                ...
                <div className="p-6 glass rounded-[24px] border border-white/5 space-y-3">
                  ...
                  <div>
                    <p className="text-[9px] font-black text-slate-500 uppercase tracking-[0.1em] mb-0.5">Custo Total</p>
              ...
              <div className="p-6 glass rounded-[24px] border border-white/5 flex items-center justify-between">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <p className="text-[9px] font-black text-slate-500 uppercase tracking-[0.1em] mb-0.5">Audiência Estimada</p>
                    <p className="text-xl font-black text-white italic">{Math.round(totalVolume).toLocaleString('pt-BR')}</p>
                  </div>
                </div>
                <div className="text-right">
                  <p className="text-[8px] font-black text-slate-600 uppercase tracking-widest mb-0.5">Custo p/ Lead</p>
              ...
              <section className="space-y-4">
                <div className="flex items-center justify-between px-2">
                  <h3 className="text-[10px] font-black text-slate-600 uppercase tracking-[0.3em]">Distribuição de Tráfego</h3>
                ...
                <div className="h-44 w-full glass rounded-[24px] border border-white/5 p-4">
                  {chartData.length > 0 ? (
                    ...
                    <div className="h-full flex flex-col items-center justify-center space-y-2 opacity-20">
                      <AlertCircle size={20} />
                      <p className="text-[8px] font-black uppercase tracking-widest">Sem dados</p>
                    </div>
                  )}
                </div>
              </section>
              ...
              <section className="space-y-4">
                <div className="flex items-center gap-2 ml-2">
                  ...
                  <h3 className="text-[10px] font-black text-white uppercase tracking-[0.2em]">Insights Estratégicos</h3>
                </div>
                ...
                <div className="grid grid-cols-1 gap-3">
                  <div className="p-4 rounded-[20px] bg-white/[0.02] border border-white/5 flex gap-4">
                    ...
                    <p className="text-[11px] text-slate-400 leading-tight font-bold uppercase">
                      {globalROI < 100 ? (
                        <><strong className="text-rose-400">Atenção:</strong> ROI abaixo de 100%. Otimize o CPC ou aumente o ticket médio.</>
                      ) : (
                        <><strong className="text-emerald-400">Excelente:</strong> ROI positivo. Momento ideal para escalar investimento.</>
                      )}
                    </p>
                  </div>
                  ...
                  <div className="p-4 rounded-[20px] bg-white/[0.02] border border-white/5 flex gap-4">
                    ...
                    <p className="text-[11px] text-slate-400 leading-tight font-bold uppercase">
                      <strong className="text-[#27CBEF]">Otimização:</strong> Use Order Bumps no checkout para elevar ROI em até 20%.
                    </p>
                  </div>
                </div>
              </section>
