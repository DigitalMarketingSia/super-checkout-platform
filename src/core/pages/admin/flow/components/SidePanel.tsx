...
import { X, Maximize2, MessageSquare, Tag, Info, ExternalLink, Trash2 } from 'lucide-react';
    ...
    <AnimatePresence>
      {selectedNodeId && (
        <motion.div
          ...
          className="absolute top-0 right-0 h-full w-[380px] z-[60] glass border-l border-white/10 flex flex-col shadow-2xl"
        >
          {/* Header */}
          <div className="p-6 border-b border-white/5 flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-[10px] font-black text-purple-400 uppercase tracking-widest mt-1">{node.data.category}</p>
              </div>
            </div>
            <button 
          ...
          <div className="flex-1 overflow-y-auto p-6 space-y-8 no-scrollbar">
            ...
            <div className="space-y-4">
              <div className="space-y-1.5">
                ...
                <input
                  ...
                  className="w-full bg-white/5 border border-white/5 rounded-2xl px-4 py-3 text-sm text-white focus:border-purple-500/50 focus:ring-0 transition-all"
                />
              </div>
            ...
            <div className="space-y-1.5">
              ...
              <textarea
                ...
                className="w-full bg-white/5 border border-white/5 rounded-2xl px-4 py-3 text-sm text-slate-300 focus:border-purple-500/50 focus:ring-0 transition-all h-32 resize-none no-scrollbar"
              />
            </div>
            ...
            <div className="pt-4 space-y-3">
              <button
                ...
                className="w-full flex items-center justify-center gap-2 py-4 bg-purple-600 hover:bg-purple-500 text-white rounded-2xl font-black text-xs uppercase tracking-widest transition-all shadow-lg shadow-purple-500/20"
              >
                <Maximize2 size={16} />
