        ...
        >
          ...
          <div className="p-6 border-b border-white/5 flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="text-sm font-black text-white leading-none">{t('flow.side_panel.title')}</h2>
          ...
          <div className="flex-1 overflow-y-auto p-6 space-y-8 no-scrollbar">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-1.5">
                <label className="text-[10px] font-black text-slate-500 uppercase tracking-widest flex items-center gap-2">
                  <Info size={12} />
                  {t('flow.side_panel.current_status')}
                </label>
            ...
            <div className="space-y-1.5">
              <label className="text-[10px] font-black text-slate-500 uppercase tracking-widest flex items-center gap-2">
                ...
                {t('flow.side_panel.strategic_notes')}
              </label>
              <textarea
                value={node.data.notes}
                onChange={(e) => updateNodeData(node.id, { notes: e.target.value })}
                placeholder={t('flow.side_panel.notes_placeholder')}
            ...
            <div className="pt-4 space-y-3">
              ...
              >
                <Maximize2 size={16} />
                {t('flow.side_panel.advanced_config')}
              </button>
              
              <button
                onClick={() => {
                  if (confirm(t('flow.side_panel.delete_confirm'))) {
                    deleteNode(node.id);
                    setSelectedNodeId(null);
                  }
                }}
