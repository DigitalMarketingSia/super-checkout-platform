        ...
        <Layout>
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
                <div>
                    <div className="flex items-center gap-2 mb-1">
                        ...
                        <span className="text-[10px] font-bold uppercase tracking-widest text-purple-400">{t('member_areas_page.control_badge')}</span>
                    </div>
                    <h1 className="text-4xl font-black text-white italic tracking-tighter uppercase leading-none">
                        {t('member_areas_page.hero_title_prefix')}{' '}
            ...
            {loading ? (
                <div className="flex flex-col items-center justify-center py-20">
                    ...
                    <p className="text-white/40 text-xs font-bold uppercase tracking-widest mt-4">{t('member_areas_page.loading')}</p>
                </div>
            ) : areas.length === 0 ? (
                <div className="text-center py-24 bg-[#0A0A15]/40 backdrop-blur-3xl rounded-[2.5rem] border border-white/5 relative overflow-hidden group">
                    ...
                    <div className="relative z-10">
                        ...
                        <h3 className="text-2xl font-black text-white italic uppercase tracking-tighter mb-3">
                            {t('member_areas_page.empty_title_prefix')}{' '}
                            <span className="text-purple-500">{t('member_areas_page.empty_title_highlight')}</span>
                        </h3>
                        ...
                        >
                            ...
                            <div className="h-40 relative overflow-hidden">
                                ...
                                <div className="absolute top-4 left-4 z-20 flex gap-2">
                                    <div className="px-3 py-1 bg-black/60 backdrop-blur-md rounded-full border border-white/5 flex items-center gap-1.5">
                                        ...
                                        <span className="text-[10px] font-bold text-white/60 tracking-tight uppercase">{t('member_areas_page.live_slug')}</span>
                                    </div>
                                </div>
                            ...
                            <div className="p-8 flex-1 flex flex-col">
                                ...
                                <div className="flex flex-col gap-3">
                                    ...
                                    >
                                        <span>{t('member_areas_page.manage_portal')}</span>
                                    ...
                                    >
                                        ...
                                        {t('member_areas_page.visit_public_access')}
                                    </a>
                                </div>
                            </div>
            ...
            <ConfirmModal
                ...
                title={t('member_areas_page.delete_title')}
                message={t('member_areas_page.delete_confirm')}
