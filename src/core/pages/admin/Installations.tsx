...
export const MyInstallations = () => {
    ...
    if (loading) {
        return (
            <Layout>
                <Loading label={t('installations.loading')} className="min-h-[70vh]" />
            </Layout>
        );
    }
                        ...
                        <div className="flex items-center gap-4">
                            <div className="flex items-center gap-4 px-6 py-4 rounded-[1.5rem] bg-white/[0.02] border border-white/5 group transition-all duration-500">
                                ...
                                <div className="flex flex-col">
                                    <span className="text-[10px] font-black text-gray-600 uppercase tracking-widest">{t('installations.header.global_status')}</span>
                                    <span className="text-[11px] font-black text-emerald-500 uppercase tracking-tighter italic">{t('installations.header.nodes_operational')}</span>
                                </div>
                            </div>
                            <Button 
                                variant="ghost" 
                        ...
                        <div className="flex items-center gap-5">
                            ...
                            <div>
                                <h3 className="text-2xl font-portal-display text-white italic uppercase tracking-tighter font-black">
                                    {t('installations.endpoints.title_prefix')} <span className="text-primary font-black">{t('installations.endpoints.title_highlight')}</span>
                                </h3>
                                <p className="text-[10px] text-gray-700 font-bold uppercase tracking-[0.2em] mt-1.5 flex items-center gap-2">
                                    <div className="w-1.5 h-1.5 rounded-full bg-primary animate-pulse" />
                                    {t('installations.endpoints.active_sync_loop')}
                                </p>
                            </div>
                        </div>
                        <div className="hidden sm:flex items-center gap-2 px-4 py-2 rounded-xl bg-white/5 border border-white/5">
                            <span className="text-[10px] font-black text-gray-500 uppercase tracking-widest leading-none">{t('installations.endpoints.cluster_size')}</span>
