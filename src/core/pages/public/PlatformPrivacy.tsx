            ...
            <main className="max-w-4xl mx-auto px-6 py-12">
                <div className="bg-[#0F0F13] border border-white/5 rounded-3xl p-8 md:p-12 shadow-2xl relative overflow-hidden">
                    ...
                    <div className="relative z-10 mb-8 rounded-2xl border border-white/5 bg-white/[0.02] p-6 text-sm text-gray-300">
                        <p><span className="font-semibold text-white">Controlador desta superficie:</span> {PLATFORM_LEGAL_ENTITY}</p>
                        ...
                        <p><span className="font-semibold text-white">Canal oficial de privacidade:</span> <a href={`mailto:${PLATFORM_LEGAL_CONTACT_EMAIL}`} className="underline underline-offset-4 hover:text-white transition-colors">{PLATFORM_LEGAL_CONTACT_EMAIL}</a></p>
                    </div>
