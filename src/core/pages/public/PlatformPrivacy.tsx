...
export const PlatformPrivacy = () => {
    ...
    const sections = getPlatformPrivacySections(i18n.language);
            ...
            <header className="border-b border-white/5 bg-white/[0.02] backdrop-blur-xl sticky top-0 z-10">
                <div className="max-w-4xl mx-auto px-6 h-20 flex items-center justify-between">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h1 className="text-lg font-bold tracking-tight">{t('legal_pages.platform_privacy.title')}</h1>
            ...
            <main className="max-w-4xl mx-auto px-6 py-12">
                <div className="bg-[#0F0F13] border border-white/5 rounded-3xl p-8 md:p-12 shadow-2xl relative overflow-hidden">
                    ...
                    <div className="relative z-10 mb-8 rounded-2xl border border-white/5 bg-white/[0.02] p-6 text-sm text-gray-300">
                        <p><span className="font-semibold text-white">{t('legal_pages.platform_privacy.controller_label')}</span> {PLATFORM_LEGAL_ENTITY}</p>
                        ...
                        <p><span className="font-semibold text-white">{t('legal_pages.platform_privacy.official_channel_label')}</span> <a href={`mailto:${PLATFORM_LEGAL_CONTACT_EMAIL}`} className="underline underline-offset-4 hover:text-white transition-colors">{PLATFORM_LEGAL_CONTACT_EMAIL}</a></p>
                    </div>
